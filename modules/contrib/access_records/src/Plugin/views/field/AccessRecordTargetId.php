...
/**
 * Field handler to display all target IDs.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("access_record_target_id")
 */
class AccessRecordTargetId extends FieldPluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['link'] = [
      '#title' => $this->t('Link to the target page'),
      '#type' => 'checkbox',
  ...
  public function query($use_groupby = FALSE) {
    ...
    $this->field_alias = $view_query->addField($alias, 'target_id', 'ar_target_id');
  }
  ...
  public function render(ResultRow $values) {
    ...
    $entity_type_id = $ar->getType()->getTargetTypeId();

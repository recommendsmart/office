 ...
 * @group pbf
 */
class PbfAccessByTermRefTest extends PbfBaseTest {
   ...
   */
  public function testPbfAccessByTermRef() {
    ...
    $this->assertSession()->elementExists('xpath', '//table[@id="field-overview"]//tr[@id="field-pbf-term"]/td[1]');

    // Check that the field appears in the overview manage display form.
    $this->drupalGet($bundle_path . '/form-display');
    $this->assertSession()->elementExists('xpath', '//table[@id="field-display-overview"]//tr[@id="field-pbf-term"]/td[1]');
